...
namespace gimi {
  ...
  public:
    ...
    void add_rgb_planar_16bit(const vector<uint8_t> &r,
                              const vector<uint8_t> &g,
                              const vector<uint8_t> &b);
    void add_rgba_interleaved_8bit(const vector<uint8_t> &);
    ...
    void add_yuv_420_planar_8bit(const vector<uint8_t> &y,
                                 const vector<uint8_t> &u,
                                 const vector<uint8_t> &v);
  ...
  protected:
    vector<vector<uint8_t>> convert_420_to_444(const vector<uint8_t> &y,
                                               const vector<uint8_t> &u,
                                               const vector<uint8_t> &v);
